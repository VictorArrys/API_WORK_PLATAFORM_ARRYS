...
exports.DemandanteDAO = class DemandanteDAO {
      ...
      if (error) {
        ...
        do {
          ...
          demandantes[cont] = {
            ...
            idperfilDemandante:
              resultadoDemandantes[cont]["id_perfil_demandante"],
          };
          cont++;
  ...
  static getDemandante(idUsuario, callback) {
    var query =
      "SELECT * FROM perfil_demandante WHERE id_perfil_usuario_demandante = ?;";
  ...
  static putDemandante(demandante, callback) {
    var query =
      "UPDATE perfil_demandante SET nonbre = ?, fecha_nacimiento = ?, telefono = ?, direccion = ? WHERE id_perfil_demandante = ? ;";
        ...
        if (codigoRespuesta == 500) {
          ...
          mysqlConnection.query(
            ...
            [
              ...
              demandante.telefono,
              demandante.direccion,
              demandante.idPerfilDemandante,
            ],
            (error, actualizacionPerfilDemandante) => {
              if (error) {
                callback(500, mensajes.errorInterno);

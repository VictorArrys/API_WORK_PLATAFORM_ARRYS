...
const { Demandante } = require('../componentes/GestionUsuarios/modelo/Demandante');
...
path.post('/v1/perfilDemandantes', (req, res) => { 
    ...
    try {
        ...
        GestionUsuarios.postDemandante(demandante, function(codigoRespuesta, cuerpoRespuesta) {
            res.status(codigoRespuesta)
            res.json(cuerpoRespuesta)
        })
...
path.put('/v1/perfilDemandantes/:idPerfilDemandante', (req, res) => { 
    ...
    try {
        if (respuesta.statusCode == 200){
            ...
            GestionUsuarios.putDemandante(edicionDemandante, function(codigoRespuesta, cuerpoRespuesta){
                res.status(codigoRespuesta)
                res.json(cuerpoRespuesta)
            })
        ...
        consoleError(error, 'Funcion: actualizar demandante. Paso: Excepcion cachada')

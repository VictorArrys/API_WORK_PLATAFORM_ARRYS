...
const { Administrador } = require('../componentes/GestionUsuarios/modelo/Administrador')
...
path.put('/v1/perfilAdministradores/:idPerfilAdministrador', (req, res) => { // listo api
    ...
    try {
        if (respuesta.statusCode == 200){
            ...
            administradorEdicion.idPerfilAdministrador = req.params.idPerfilAdministrador
            ...
            GestionUsuarios.putAdministrador(administradorEdicion, function(codigoRespuesta, cuerpoRespuesta) {
                res.status(codigoRespuesta)
                res.json(cuerpoRespuesta)
            })
        }else if (respuesta.statusCode == 401){
